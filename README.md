...
- `expectMinutes` sets the floor of the expected duration for lanes and jobs, default 15. A longer median from matching history raises it; an explicit expected duration replaces it.
